...
3. Das Frontend ist unter [http://localhost:3000](http://localhost:3000) erreichbar.
...
### Hinweise
- Standard-Testnutzer werden beim ersten Start automatisch angelegt (siehe Backend-Logs).
